...
class GreenChilly extends Restaurant{
	...
	public static final GreenChilly INSTANCE=new GreenChilly();
	public static GreenChilly getInstance(){
		return INSTANCE;
	}
...
class HiKolkata extends Restaurant{
	...
	private HiKolkata(){
		super("Hi!Kolkata","7827054646");
	}	
	
	public static final HiKolkata INSTANCE=new HiKolkata();
	public static HiKolkata getInstance(){
		return INSTANCE;
	}
...
class DrMomo extends Restaurant{
	...
	private DrMomo(){
		super("Dr.Momo","8130420150");
	}	
	
	public static final DrMomo INSTANCE=new DrMomo();
	public static DrMomo getInstance(){
		return INSTANCE;
	}
