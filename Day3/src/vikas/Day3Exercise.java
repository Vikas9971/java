		...
		do{
			...
			switch(ch){
				...
				case 4:System.out.println("Welcome to FoodPanda!!");
						...
						res=food.getRestaurant(item);
						if(res!=null){
							JOptionPane.showMessageDialog(null,"You can find this food at :"+res.getName()+"\nContact No:"+res.getPhoneNumber());
						}
						else{JOptionPane.showMessageDialog(null,"Sorry! we couldn't find you a restaurant offering "+item);}
					break;
				case 5:System.out.println("The three subclasses of restaurant are singleton");
						br.readLine();
					break;
